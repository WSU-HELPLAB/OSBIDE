...
{
    public static class CommonPkgCmdIDList
    {
        public const uint cmdidOsbideCommand = 0x100;
        public const uint cmdidOsbideStatusTool = 0x101;
        public const uint cmdidOsbideLoginToolWin = 0x102;
        public const uint cmdidOsbideActivityFeedTool = 0x103;
        ...
        public const uint cmdidOsbideSubmitAssignmentCommand = 0x10B;
