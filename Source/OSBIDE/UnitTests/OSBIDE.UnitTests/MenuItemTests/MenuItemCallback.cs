...
namespace OSBIDE.UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = OSBIDE.VSPackage.() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(OSBIDE.VSPackage.GuidList.guidOSBIDE_VSPackageCmdSet, (int)OSBIDE.VSPackage.PkgCmdIDList.cmdidOsbideCommand);
        ...
        {
            // Create the package
            IVsPackage package = new OSBIDEPackage() as IVsPackage;
            Assert.IsNotNull(package, "The object does not implement IVsPackage");
