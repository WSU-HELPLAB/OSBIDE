...
namespace OSBIDE.IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(OSBIDE.VSPackage.GuidList.guidOSBIDE_VSPackageCmdSet, (int)OSBIDE.VSPackage.PkgCmdIDList.cmdidOsbideCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "OSBIDE", "WSU.OSBIDE.OSBIDEPackage");
