(function () {
    ...
    d3.trendingCalendar = function () {
        ...
        var rowCount = 10, colCount = 7, cellCount = 70;
        ...
        function trendingCalendar(g) {
            ...
            var cellPositions = [];
            for (idxy = 0; idxy < rowCount; idxy++) {
                for (idxx = 0; idxx < colCount; idxx++) {
            ...
            g.each(function (inputData) {
                ...
                for (var m = 0; m < inputData.dailyAggregations.measures.length; m++) {
                    ...
                    // measure data
                    var measure = inputData.dailyAggregations.measures[m];
                    ...
                    var dataindex = $.map(cellPositions[firstCellId].data, function (md, mi) {
                ...
                // events
                g.append("svg:g").selectAll("eventText").data(inputData.dailyAggregations.activities).enter().append("text")
                                     .attr("x", function (d, i) {
